      ...
      <div className="2xl:flex justify-between">
        <div>
          <div className="flex items-center">
            ...
            <div className="w-80 h-5 mx-4 bg-gray-400 rounded ">
              <div className="h-5 bg-blue-700 rounded" style={{ width: '70%' }}></div>
            </div>
          ...
          <div className="flex items-center mt-4">
            ...
            <div className="w-80 h-5 mx-4 bg-gray-400 rounded ">
              <div className="h-5 bg-blue-700 rounded" style={{ width: '17%' }}></div>
            </div>
            <span className=" font-bold text-black ">17%</span>
          </div>
          <div className="flex items-center mt-4">
            <span className=" font-bold text-black ">3 star</span>
            <div className="w-80 h-5 mx-4 bg-gray-400 rounded ">
              <div className="h-5 bg-blue-700 rounded" style={{ width: '8%' }}></div>
            </div>
          ...
          <div className="flex items-center mt-4">
            ...
            <div className="w-80 h-5 mx-4 bg-gray-400 rounded ">
              <div className="h-5 bg-blue-700 rounded" style={{ width: '4%' }}></div>
            </div>
          ...
          <div className="flex items-center mt-4">
            ...
            <div className="w-80 h-5 mx-4 bg-gray-400 rounded ">
              <div className="h-5 bg-blue-700 rounded" style={{ width: '1%' }}></div>
            </div>
        ...
        <div className="">
          <div className="flex items-center">
            ...
            <p className="ml-2  font-bold text-black">4.95 out of 5</p>
          </div>
          <p className=" font-bold text-black">1,745 global ratings</p>
        </div>
      </div>
    </>
  );
