...
export default function Profile({ userProfile }: Props) {
  ...
  return (
    <>
      ...
      <ToastContainer />
      <main className="">
        <div className="flex bg-white min-h-screen px-10 py-10 ">
          <div className="container">
            <div className="flex justify-center">
              <div>
                ...
                <div className="py-4">
                  <button
                    className="text-white inline-flex items-center bg-yellow-500 hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-3 text-center"
                    onClick={() => {
                  ...
                  {localImg && image && (
                    <div className="inline-flex px-2">
                      <button
                        className="mx-4 inline-flex items-center px-5 py-3 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-full"
                        onClick={() => {
                      ...
                      <button className="inline-flex items-center px-5 py-3 bg-gray-200 hover:bg-gray-300 text-gray-800 text-sm font-medium rounded-full" onClick={uploadImage}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
