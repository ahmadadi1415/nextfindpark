...
const Login: NextPage = ({ providers }: any) => {
  ...
  return (
    <>
      ...
      <Navbar />
      <div>
        <main className="lg:p-36 px-2 lg:flex items-center justify-between min-h-screen bg-white ">
          <div>
            <Formik
                ...
                <Form>
                  <div>
                    ...
                    <Field name="email">
                      {() => (
                        <div className="pb-2">
                          <input type="email" name="email" className="rounded-lg w-96 text-black" value={props.values.email} onChange={props.handleChange} onBlur={props.handleBlur} placeholder="Email" />
                  ...
                  <div>
                    <div className="bg-yellow-500 hover:bg-yellow-600 rounded-full font-bold text-center w-44 h-12">
                    ...
                    <div className="text-left mt-2">
                      <p className="text-gray-500">
                        ...
                        <a href="/registration" className="font-medium text-yellow-600 hover:underline">
                          {' '}
                          disini
                        </a>
                      </p>
...
export const loginUser = async (values: FormikValues, actions: any) => {
  ...
  const loginInfo = await axios.post('/api/auth/check-login', JSON.stringify(values), {
    headers: {
